 ...
 */
final class Version20200215174358 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD COLUMN enabled BOOLEAN DEFAULT \'0\' NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_9474526CF675F31B ON comment (author_id)');
        $this->addSql('CREATE INDEX IDX_9474526CA77FBEAF ON comment (blog_post_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, username, name, password, email, roles, password_change_date FROM user');
        ...
        $this->addSql('INSERT INTO user (id, username, name, password, email, roles, password_change_date) SELECT id, username, name, password, email, roles, password_change_date FROM __temp__user');
